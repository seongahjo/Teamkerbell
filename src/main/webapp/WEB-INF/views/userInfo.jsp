...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <!-- Logo -->
        <a href="../dashboard/${userId}" class="logo">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="../${img}" class="user-image" alt="">
            ...
            <form role="form">
              <div class="box-body">
                <div class="form-group">
                  <label> ID </label>
                  <input type="text" class="form-control" placeholder="Sieun" disabled>
                </div>
				<div class="form-group">
                  <label>Name</label>
                  <input type="text" class="form-control" placeholder="kimsieun" disabled>
                </div>
                <div class="form-group">
